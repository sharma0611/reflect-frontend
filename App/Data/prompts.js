...
const GOALS_COPY = {
    [FAMILY]: [
        ...
        'Show gratitude to a family member about something they have done that means a lot to me',
        'Tell a family member something I have never told them'
    ],

    [FRIENDS]: [
        'Call an old friend and catch up',
        'Compliment a friend for something they have recently achieved. Make them feel appreciated & proud',
        ...
        'Write a thank you note to a friend about something they have done that means a lot to me',
    ...
    [PRODUCTIVITY]: [
        ...
        'Keep my emails in check. Organize them into folders and reduce the emails in my inbox',
...
const CATEGORY_SUBTITLES = {
    ...
    [SCHOOL]: 'Set yourself up for success.',
    [CAREER]: 'Feel self-fullfilled in your work.',
    [PHYSICAL]: 'A healthy mind needs a healthy body.',
    [FINANCIAL]: 'Feel good about your finances.'
}
